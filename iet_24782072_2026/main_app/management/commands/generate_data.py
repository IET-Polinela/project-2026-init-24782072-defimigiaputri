    ...
    def handle(self, *args, **kwargs):
        ...
        context_data = {
            'Jalan Rusak': {
                ...
                'desc': 'Ditemukan kerusakan jalan yang cukup dalam. Mohon segera diperbaiki sebelum memakan korban jiwa.'
            },
            'Sampah': {
                'titles': [
            ...
            'Lampu Mati': {
                ...
                'desc': 'Lampu jalan di area ini mati total sejak kemarin malam.'
            },
            'Drainase': {
                'titles': [
                    'Saluran Air Mampet',
                ...
                'desc': 'Saluran air tersumbat sehingga setiap kali hujan turun, air meluap.'
            },
            'Keamanan': {
                'titles': [
                ...
                'desc': 'Dibutuhkan patroli tambahan di area ini karena laporan aktivitas mencurigakan.'
            }
        }
